...
export const FAULT_CATEGORY_META: FaultCategoryMeta[] = [
  {
    ...
    queryCopy: 'User feedback glucose data showed discrepancies compared to BGM, also included instances of data appearing as a straight line, persistent low glucose, or jump and down data.',
    tags: [
  ...
  },
  {
    ...
    shortCopy: 'The sensor unexpectedly fall outwhile the user was wearing it.',
    queryCopy: 'The sensor unexpectedly fall outwhile the user was wearing it.',
    tags: [
  ...
  },
  {
    ...
    shortCopy: "The sensor is worned correctly, but the app's homepage is displaying an error message.",
    queryCopy: "The sensor is worned correctly, but the app's homepage is displaying an error message.",
    tags: [
